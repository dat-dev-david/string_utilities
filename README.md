...
•utils.despace(string) - removes whitespace from your string.
...
V0.2 - Future insights 
===========================================================================================================================================
-add more container support like: *map*, *queue* & *list*

-add `size_t` ranges for more fuctionality

-and have fun  [yeah thats not happening bromacho :/]
